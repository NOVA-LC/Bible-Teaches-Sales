...
# All other phrases that exist in 2026-05-10-w.json — we don't pin exact
# positions but DO require that they resolve without error.
ARTICLE_PHRASE_RESOLVES = [
    (7, "should be teachers"),
    (7, "spoke in such a manner"),
    (8, "limited secular education"),
    (8, "discouraged about their teaching ability"),
    (10, "knew what was in man"),
    (10, "matters that affected them personally"),
    (11, "trying to understand their concerns"),
    (11, "without the hope that the Bible offers"),
    (12, "kindness and respect"),
    ...
    (13, "gracious, seasoned with salt"),
    (15, "freely quoted from the inspired Scriptures"),
    (15, "as one having authority"),
    (16, "Scriptural explanation of the prophecies"),
    (16, "not a highly educated man"),
    (16, "about 3,000 people were added"),
    (17, "no better tool"),
    (17, "letting Jehovah speak"),
    (17, "far superior to human wisdom"),
    (18, "look up key texts"),
    (18, "give the student time to absorb"),
    (18, "not a book study or a picture study"),
    (19, "with all patience"),
    (19, "preach the word"),
    (19, "extra time to grasp truths"),
    (20, "completely unfamiliar with the Bible"),
    (20, "show your Bible students the power"),
    (20, "drawing out students with questions"),
    (22, "attention on Jehovah"),
    (22, "lighting technician in a theater"),
    (22, "in the spotlight"),
    (23, "develop the desire to please Jehovah"),
    (23, "joining a club"),
    (23, "what a wonderful Father we have"),
    (25, "ask Jehovah in prayer"),
    (25, "through his eyes"),
    (25, "close friendship with Jehovah"),
    (26, "one of the greatest joys"),
